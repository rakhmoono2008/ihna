Вот полный текст `bot.py` с уже сделанными заменами (murojaat → taklif, обращение → предложение во всех языках):
...
APPEAL_TYPES = {
    ...
    "atype_2": {"ru": "💰 Стимулирование",                     "uz": "💰 Rag'batlantirish",               "kk": "💰 Yntalandırıw"},
...
TEXTS = {
    ...
    "uz": {
        ...
        "contacts_text":  "📞 Kontakt ma'lumotlari\n\nSavollaringiz bo'lsa — " + CONTACT_USERNAME + " ga taklif qiling",
    ...
    "kk": {
        "welcome":        "Xosh keldiniz!\n\nBul bot O'zbekistan puqaralarinin taklifların qabıl etiw ushin.\n\nTildi tanlang:",
        "menu":           "Bas menyu\n\nAmaldı tanlang:",
        "btn_new":        "Jana taklif",
        "btn_my":         "Menin takliflarım",
        "btn_rules":      "Qaydalar",
        "btn_lang":       "Tildi ozgertiw",
        "btn_contacts":   "Kontaktlar",
        "contacts_text":  "📞 Baylanıs maglıwmatları\n\nSawallarınız bolsa — " + CONTACT_USERNAME + " ge taklif eting",
        "choose_type":    "Taklif turın tanlang:",
        ...
        "anon_warning":   "Siz anonimlikti tanladınız.\nTaklif jetkiziledi, biraq biz siz benen baylanısa almaymız.",
        "choose_region":  "Regionınızdı tanlang:",
        "send_appeal":    "Taklifınızdı jazın\n\nMatn jazın (birneshe xabar jibere alasız).\nSuwret/video — boleksha jiberin.\n\nTayar bolganda — to'mendegi tugmasin basın.",
        "submit_btn":     "Taklif jiberiw",
        "cancel_btn":     "Biykar etiw",
        "thank_you":      "Taklifınız qabıl etildi!\n\nKo'p rahmet. Taklifınızdı ko'rib shıgamız.\n\nMenin takliflarım boliminde jawaplardı kore alasız.",
        "media_received": "Fayl qabıl etildi. Yana qosın yaki Taklif jiberiw ni basın.",
        "text_added":     "Matn qosıldı. Davom etin yaki Taklif jiberiw ni basın.",
        "admin_header":   "JANA TAKLIF",
        "type_label":     "Tur",
        "region_label":   "Region",
        ...
        "reply_prompt":   "#{aid}-taklif ushin jawap jazın:",
